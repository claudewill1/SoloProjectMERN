...
const CoinForm = (props) => {
    const {initialCoinType, initialDenomination, initialValue, initialDescription, initialGraded, initialGradingService,initialCertificationNumber, onSubmitProp} = props;
